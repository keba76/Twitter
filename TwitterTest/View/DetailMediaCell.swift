...
class DetailMediaCell: UITableViewCell {
    ...
    func tweetSetConfigure(tweet: ViewModelTweet) {
       ...
       // userPic.sd_setImage(with: tweet.userAvatar)
...
//                }.addDisposableTo(self.dis)
            ...
            tapMedia.rx.event
                ...
                .subscribe(onNext: {[weak self] _ in
                    ...
                    s.delegate?.extensionProfVC(someTweetsData: SomeTweetsData(convert: instinctConvert, indexPath: s.indexPath))
